...
describe('Blockchain', () => {
    ...
    // Create a new instance of Blockchain class before each test
    beforeEach(() => {
    ...
    describe('replaceChain()', () => {
        ...
        // Create a temporary method for tests
        beforeEach(() => {
            logMock = jest.fn();
        ...
        describe('and the `validateTransactions` flag is true', () => {
            it('calls validTransactionData()', () => {
                ...
                newChain.addBlock({ data: 'foo' }); // Needs to be longer than original chain
